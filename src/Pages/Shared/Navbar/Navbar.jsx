...
const Navbar = () => {
  ...
  const navItems = <div className='grid lg:flex justify-between items-center'>
    <div>
      <NavLink
        to="/"
    ...
    <NavLink className=" ml-0 mt-1 lg:ml-10 lg:-mt-4">
      <label onClick={() => toggleTheme()} className="swap swap-rotate">
